...
export const phases = [
  ...
  },
  {
    ...
    kicker: "The dormer",
    copy: "The owner asked for more light in the loft. We opened the roof and framed an additional dormer. A change request is not a delay — it is the house becoming itself.",
